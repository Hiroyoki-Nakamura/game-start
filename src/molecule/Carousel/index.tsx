...
const Carousel: React.FC<{ className: string, cardsData: ICardProps[] }> = ({ className, cardsData }) => {
    ...
    return (
        <div className={className}>
            <div className="flex overflow-x-auto space-x-4 p-40 justify-center bg-white" ref={carouselRef}>
